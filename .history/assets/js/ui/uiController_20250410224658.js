        ...
        resultHTML += `
            ...
            <div class="d-grid gap-2">
                <button id="confirmTransactionBtn" class="btn btn-primary">
                    <i class="fas fa-check-circle me-2"></i>Confirmar e Prosseguir
                </button>
            </div>
        `;
            ...
            <div class="card-body">
                <form id="walletForm">
                    <div class="mb-3">
                        ...
                        <select id="networkSelect" class="form-select" required>
                            ${networkOptions}
                        </select>
                        <div class="form-text">
                            ${toCrypto === 'USDT' ? 
                                '<strong class="text-danger">ATENÇÃO:</strong> O USDT está na rede <strong>TRON</strong>. Você <strong>DEVE</strong> usar um endereço TRON compatível, ou perderá seus fundos!' : 
                                'Selecione a rede blockchain para receber seus tokens.'}
                        </div>
                    </div>
                    
                    <div class="mb-3">
                        <label for="walletAddress" class="form-label">Endereço da carteira ${toCrypto === 'USDT' ? 'TRON' : ''}</label>
                        <input type="text" class="form-control" id="walletAddress" 
                            placeholder="${toCrypto === 'USDT' ? 'Endereço TRON começa com T... (Ex: TXo71H...)' : 'Endereço da carteira...'}" 
                            value="${savedAddress || ''}" required>
                        <div class="form-text text-danger fw-bold">
                            IMPORTANTE: Verifique cuidadosamente o endereço. Transações em blockchain são irreversíveis.
                        </div>
                    </div>
                    ...
                    <div class="alert alert-warning mb-3">
                        <div class="form-check">
                            ...
                            <label class="form-check-label fw-bold" for="addressConfirmation">
                                Eu confirmo que este endereço está correto e é um endereço ${toCrypto === 'USDT' ? 'TRON válido' : `${defaultNetwork} válido`}
                            </label>
                        </div>
                    </div>
    ...
    if (kycForm) {
        kycForm.addEventListener('submit', (e) => {
            ...
            setTimeout(() => {
                ...
                const successHTML = `
                    <div class="alert alert-success">
                        <h4 class="alert-heading"><i class="fas fa-check-circle me-2"></i>Verificação KYC Enviada!</h4>
                        ...
                        <div class="mb-3">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><strong>Endereço de envio:</strong> ${walletAddress}</li>
                                <li><strong>Status da verificação:</strong> <span class="badge bg-warning">Em análise</span></li>
                            </ul>
                        </div>
                        <p class="mb-0">O valor será creditado na sua carteira assim que a verificação for concluída, em até 24h.</p>
