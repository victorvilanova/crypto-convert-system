            ...
            <div class="card-body">
                <form id="walletForm">
                    <div class="mb-3">
                        ...
                        <div class="form-text">
                            ${toCrypto === 'USDT' ? 
                                '<strong>ATENÇÃO:</strong> O USDT utiliza a rede TRON por padrão. Certifique-se de que seu endereço é compatível.' : 
                    ...
                    <div class="form-check mb-3">
                        ...
                        <label class="form-check-label" for="addressConfirmation">
                            Confirmo que este endereço está correto e é compatível com a rede ${defaultNetwork}
                        </label>
                    </div>
...
function processTransaction(fromCurrency, toCrypto, amount, finalAmount, network, walletAddress) {
    ...
    setTimeout(() => {
        ...
        const successHTML = `
            <div class="alert alert-success">
                <h4 class="alert-heading"><i class="fas fa-check-circle me-2"></i>Transação Concluída!</h4>
                <p>Sua conversão de ${formattedAmount} para ${formattedFinalAmount} ${toCrypto} foi processada com sucesso.</p>
                <hr>
                <div class="mb-3">
                ...
                <p class="mb-0">O valor será creditado na sua carteira em instantes. Você pode acompanhar a transação pelo explorer da blockchain.</p>
        ...
        // Adicionar à lista de transações recentes (implementação real utilizaria armazenamento)
