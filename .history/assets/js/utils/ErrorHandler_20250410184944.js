...
export default class ErrorHandler {
  ...
  getUserFriendlyMessage(error, errorType) {
    ...
    const errorMessages = {
      [errorTypes.API_ERROR]: 'Não foi possível comunicar com o servidor de taxas. Tente novamente mais tarde.',
      [errorTypes.VALIDATION_ERROR]: error.message,
      [errorTypes.CONVERSION_ERROR]: 'Não foi possível realizar a conversão com os valores informados.',
      [errorTypes.NETWORK_ERROR]: 'Você parece estar offline. Verifique sua conexão com a internet.',
      [errorTypes.UNKNOWN_ERROR]: 'Ocorreu um erro inesperado. Por favor, tente novamente.'
    };
